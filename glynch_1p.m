...
options_r = NoRMCorreSetParms('d1', nx - bound, 'd2', ny - bound, ...
...
roi = Y(bound/2+1 : end-bound/2, bound/2+1 : end-bound/2, :);
...
Mr = apply_shifts(Yf, shifts1, options_r, bound/2, bound/2);
